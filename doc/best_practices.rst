...
.. _do-not-create-multiple-smbus-instances-for-the-same-bus:
...
(`#75 <https://github.com/kplindegaard/smbus2/issues/75>`_).
...
.. _prefer-i2c-rdwr-for-devices-that-do-not-use-the-register-address-protocol:
...
`#110 <https://github.com/kplindegaard/smbus2/issues/110>`_).
...
(`#35 <https://github.com/kplindegaard/smbus2/issues/35>`_,
`#67 <https://github.com/kplindegaard/smbus2/issues/67>`_,
`#99 <https://github.com/kplindegaard/smbus2/issues/99>`_):
...
.. _add-small-delays-between-operations-on-slow-devices:
...
(`#33 <https://github.com/kplindegaard/smbus2/issues/33>`_,
`#36 <https://github.com/kplindegaard/smbus2/issues/36>`_):
...
.. list-table::
   ...
   * - ``errno``
     - Meaning
   * - 5 (``EIO``)
     - Input/output error — bus-level failure, noise, or NAK
   * - 121 (``EREMOTEIO``)
     - Remote I/O error — slave did not ACK the address or command
   * - 16 (``EBUSY``)
     - Bus busy — another master or driver is using the bus
