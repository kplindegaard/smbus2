...
(`#73 <https://github.com/kplindegaard/smbus2/issues/73>`_).
...
(`#34 <https://github.com/kplindegaard/smbus2/issues/34>`_).
...
buffer overflow
(`#124 <https://github.com/kplindegaard/smbus2/issues/124>`_).
...
- **Wrong byte count** — some devices return a length byte as the first byte of a block
  ...
  (`#68 <https://github.com/kplindegaard/smbus2/issues/68>`_).
- **Register-byte confusion** — if the device does not use register addressing, the
  ...
  (`#115 <https://github.com/kplindegaard/smbus2/issues/115>`_,
  `#101 <https://github.com/kplindegaard/smbus2/issues/101>`_).
...
- A driver bound to the device blocking the ``ioctl`` call
  (`#76 <https://github.com/kplindegaard/smbus2/issues/76>`_,
  `#108 <https://github.com/kplindegaard/smbus2/issues/108>`_).
...
(`#78 <https://github.com/kplindegaard/smbus2/issues/78>`_).
