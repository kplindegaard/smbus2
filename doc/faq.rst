...
See `#73 <https://github.com/kplindegaard/smbus2/issues/73>`_ and
:ref:`platform-support`.
...
See `#35 <https://github.com/kplindegaard/smbus2/issues/35>`_,
`#67 <https://github.com/kplindegaard/smbus2/issues/67>`_,
`#99 <https://github.com/kplindegaard/smbus2/issues/99>`_, and
:ref:`combined-transactions-with-i2c-rdwr`.
...
two messages.
See `#25 <https://github.com/kplindegaard/smbus2/issues/25>`_ and
:ref:`write-then-read-repeated-start`.
...
See `#54 <https://github.com/kplindegaard/smbus2/issues/54>`_.
...
See `#19 <https://github.com/kplindegaard/smbus2/issues/19>`_,
`#84 <https://github.com/kplindegaard/smbus2/issues/84>`_,
`#117 <https://github.com/kplindegaard/smbus2/issues/117>`_, and
:ref:`reading-devices-that-have-no-register-address`.
...
See `#18 <https://github.com/kplindegaard/smbus2/issues/18>`_ and
:ref:`asyncio-async-support`.
...
See `#77 <https://github.com/kplindegaard/smbus2/issues/77>`_ and
...
See :ref:`signed-integer-conversion` for the full recipe including 16-bit words.

Where is the API documentation?
---------------------------------

Full API documentation is available in the :doc:`api` section of this documentation,
and hosted online at https://smbus2.readthedocs.io/en/latest/.
