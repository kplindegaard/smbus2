...
**Q: Does smbus2 work on Windows or macOS?**
...
**Q: Can I read or write more than 32 bytes at once?**
...
**Q: How do I perform a repeated start (write then read without STOP)?**
...
**Q: Can I use 10-bit I2C addresses?**
...
**Q: Why does my device not respond when I use `read_byte_data` or `write_byte_data`?**
...
**Q: Can I use smbus2 with asyncio?**
...
**Q: How do I set the I2C clock speed?**
...
**Q: Can I open multiple `SMBus` instances for the same bus in one process?**
...
**Q: What happened to `SMBusWrapper`?**
...
**Q: How do I convert a raw unsigned value to a signed integer?**
