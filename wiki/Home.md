...
> **Note:** This wiki was generated by GitHub Copilot. While every effort has been made to ensure accuracy, please verify information against the [official API documentation](https://smbus2.readthedocs.io/en/latest/) and the [source code](https://github.com/kplindegaard/smbus2).
